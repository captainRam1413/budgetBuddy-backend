        ...
        try:
            ...
            try:
                ...
                if not admin:
                    ...
                    db.session.commit()
                    print("[Seed] Default admin user (admin@budgetbuddy.com) seeded.")
            except Exception as se:
                print(f"[Seed Note] {se}")

            print("[Success] Database tables initialized via SQLAlchemy ORM.")
        except Exception as e:
            print(f"[Warning] Error during db initialization: {e}")
